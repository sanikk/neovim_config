...
-- Testing autocommand to load python snippets

vim.api.nvim_create_autocmd('FileType', {
    pattern = 'python',
    callback = function()
        require('luasnip.loaders.from_lua').load { paths = { '~/.config/snippets/python.lua' } }
    end,
})
...
--   pattern = 'python',
--   callback = function()
--     require('luasnip.loaders.from_lua').load { paths = { '~/.config/nvim/snippets/python.lua' } }
--     print 'Python snippets loaded'
--   end,
-- })
