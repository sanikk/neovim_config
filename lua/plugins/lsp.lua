return {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        clangd = {
          cmd = { 'clangd', '--compile-commands-dir=build' }, -- Replace 'build' with your build directory
          capabilities = {}, -- Extend capabilities as needed
          on_attach = function(client, bufnr)
            -- Optional: Custom logic for clangd on_attach
